...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.75-kirby-problem-3.75-10a8cb0c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.75"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.75-kirby-problem-3.75-10a8cb0c-v1",
      "problem_contract_sha256": "12a2b5bec47e23d4c4f682d3618469dc337e11861732eb3063378e3f7cc722f7",
      "problem_id": "problem:um-kp-3.75-kirby-problem-3.75-10a8cb0c",
      "route_id": "route:um-kp-3.75-kirby-problem-3.75-10a8cb0c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.75-kirby-problem-3.75-10a8cb0c-source-fidelity-01",
      "graph_id": "graph:um-kp-3.75-kirby-problem-3.75-10a8cb0c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.75-kirby-problem-3.75-10a8cb0c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.75-kirby-problem-3.75-10a8cb0c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $Y$ be a rational homology 3-sphere equipped with an action of a cyclic group $\\mathbb{Z}/p\\mathbb{Z}$. Suppose $W$ is a 4-manifold with boundary $Y$ over which the action of $\\mathbb{Z}/p\\mathbb{Z}$ extends smoothly. (a) What constraints are there on the intersection form of $W$? (b) Does there exist an integer homology sphere $Y$ bounding a homology ball such that $Y$ admits a cyclic group action that does not extend over any definite manifold of either sign? (c) Develop methods for constraining the intersection form of $W$ that apply to indefinite, non-spin $W$."
          },
          "statement_sha256": "2c7189fb26c1e53a1a12feca46a2e0a5e3b279ef35048deb83cfd050e333fcc4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.75-kirby-problem-3.75-10a8cb0c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.75-kirby-problem-3.75-10a8cb0c-root",
      "route_id": "route:um-kp-3.75-kirby-problem-3.75-10a8cb0c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.75-a922a7149818",
        "url": "https://www.unsolvedmath.com/problems/KP-3.75"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
